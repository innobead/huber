...
pub enum Commands {
    ...
    #[command(about = "Show command completions for the specified shell", bin_name = "completions")]
    Completions {
    ...
    #[command(about = "Load installed packages from a file generated by save command", bin_name = "load")]
    Load(LoadArgs),
